...
class niah_scanner_sbom():
    ...
    def syncData(self, ecosystem):
        ...
        # license_key = self.get_license_key(api_key, ip)
        ...
        # json_data = {
        #     'api-key': '%s' % license_key,, headers=headers
        # }
        
        api_url = 'http://34.27.234.8:8080/api/v1/scan/advisor/%s/%s' % (ecosystem.lower(), ecosystem.lower())
        print(api_url)
    ...
    def scan_bom(self, sbomdata, ecosystem):
        ...
        results = {}
        results['header'] = {}
        results['header']['ecosystem'] = ecosystem
